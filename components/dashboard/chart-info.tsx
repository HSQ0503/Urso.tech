  ...
  return (
    <span className="group/ci relative inline-flex align-middle">
      ...
      >
        ...
        <span className="mt-2 block font-sans text-[11.5px] normal-case leading-[1.5] tracking-normal text-ink-dim">{t(g.read)}</span>
        {g.legend && (
        ...
        {g.source && (
          <span className="mt-2.5 block font-mono text-[9px] uppercase tracking-[0.12em] text-ink-dimmer">{t(g.source)}</span>
        )}
      </span>
    </span>
  );
