      ...
      >
        {launched ? (
          <p className="text-[13.5px] leading-[1.6] text-ink-dim">
            The Retention agent is sending a personalised rebooking link to {winbackCount} lapsed customers over a short, spaced sequence. Replies and rebookings will show up on the AI actions page.
          </p>
        ) : (
          <p className="text-[13.5px] leading-[1.6] text-ink-dim">
