...
const TOOL_LABELS: Record<string, string> = {
  ...
  store_day_tickets: "itemized tickets",
  profit_and_loss: "profit & loss",
  cost_breakdown: "cost breakdown",
  cost_benchmark: "store cost benchmark",
  profit_per_booking: "profit per booking",
  service_line_margin: "service-line margin",
  breakeven: "break-even",
  cost_spikes: "cost spikes",
  groomer_client_book: "customer–groomer links",
  find_customer: "customer lookup",
  customer_profile: "customer profile",
  customer_watchlist: "overdue watchlist",
  revenue_series: "revenue trend",
  groomer_retention: "groomer retention",
  demand_heatmap: "demand heatmap",
  discount_analysis: "discount analysis",
  groomer_monthly_series: "groomer trend",
  propose_knowledge_update: "queueing knowledge for review",
};
