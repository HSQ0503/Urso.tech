...
export default function CanesTermsPage() {
  return (
    <div className="mx-auto max-w-[640px] px-5 py-12">
      ...
      <h1 className="cp-display mt-1.5 text-[26px]">SMS Terms &amp; Conditions</h1>
      ...
      <div className="mt-6 space-y-5 text-[14.5px] leading-relaxed text-[var(--cp-ink)]">
        <section>
          <h2 className="cp-display text-[17px]">Program description</h2>
          <p className="mt-1.5">
        ...
        <section>
          <h2 className="cp-display text-[17px]">Frequency and rates</h2>
          <p className="mt-1.5">
        ...
        <section>
          <h2 className="cp-display text-[17px]">Opting out and help</h2>
          <p className="mt-1.5">
        ...
        <section>
          <h2 className="cp-display text-[17px]">Carriers</h2>
          <p className="mt-1.5">
        ...
        <section>
          <h2 className="cp-display text-[17px]">Privacy</h2>
          <p className="mt-1.5">
            Our{" "}
            <a
