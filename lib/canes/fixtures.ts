...
export const DEMO_INVOICES: Invoice[] = [
  ...
  // must ask for the $180 balance, never the $280 face total.
  {
    ...
    total_cents: 28000, amount_paid_cents: 10000, settlement_generation: 0,
  ...
  // inv1 — SENT, awaiting card payment (backs completed job6).
  {
    ...
    total_cents: 42500, amount_paid_cents: 0, settlement_generation: 0,
    message_to_customer:
  ...
  // inv2 — PAID in cash (backs job7 + payment pay2).
  {
    ...
    total_cents: 25000, amount_paid_cents: 25000, settlement_generation: 1,
    message_to_customer:
  ...
  ...([
    ...
    total_cents: r.total, amount_paid_cents: r.total, settlement_generation: 1,
  ...
  //    amount and voided; inv10 is the corrected re-bill, still unpaid + overdue.
  {
    ...
    total_cents: 63000, amount_paid_cents: 0, settlement_generation: 0,
    message_to_customer: "Thanks for choosing Canes Pressure Washing!",
    terms: "Payment is due upon receipt. Thank you for your business.",
  ...
  },
  {
    ...
    total_cents: 36000, amount_paid_cents: 0, settlement_generation: 0,
  ...
  // inv11 — Priya's third job, settled by card (repeat-customer lifetime value).
  {
    ...
    total_cents: 38000, amount_paid_cents: 38000, settlement_generation: 1,
    message_to_customer: "Thanks for choosing Canes Pressure Washing!",
    terms: "Payment is due upon receipt. Thank you for your business.",
